...
def preprocess_image(img: Image.Image) -> np.ndarray:
    ...
    reshaped = arr.reshape(1, 64, 64, 1)
    return reshaped
...
# UI
st.title("🤖 Hand Gesture Recognition")
st.markdown("Upload a hand gesture image and get the prediction instantly.")
...
st.info("⚠️ Webcam mode is disabled on Streamlit Cloud (not supported). Run locally if needed.")
